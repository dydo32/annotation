...
public class SearchController {
	...
	@RequestMapping(value="/search.do",method=RequestMethod.POST)	//method -> post방식
	public ModelAndView search(@RequestParam String addr, String test){	//@RequestParam을 사용해서 받아도 되고, name이 같게 String으로 매개변수 주어도됨
